...
class BootLinuxConsole(Test):
    ...
    def test_rx_uboot(self):
        ...
        :avocado: tags=endian:little
        """
        uboot_url = ('https://osdn.net/users/ysato/pf/qemu/dl/u-boot.bin.gz')
    ...
    def test_rx_linux(self):
        ...
        :avocado: tags=endian:little
        """
        dtb_url = ('https://osdn.net/users/ysato/pf/qemu/dl/rx-virt.dtb')
        dtb_hash = '7b4e4e2c71905da44e86ce47adee2210b026ac18'
        dtb_path = self.fetch_asset(dtb_url, asset_hash=dtb_hash)
        kernel_url = ('https://osdn.net/users/ysato/pf/qemu/dl/zImage')
