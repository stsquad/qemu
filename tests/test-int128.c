...
static void __attribute__((__noinline__)) ATTRIBUTE_NOCLONE
test_shr_one(uint32_t x, int n, uint64_t h, uint64_t l)
{
    Int128 a = expand(x);
    Int128 r = int128_shr(a, n);
    g_assert_cmpuint(int128_getlo(r), ==, l);
    g_assert_cmpuint(int128_gethi(r), ==, h);
}
...
{
    test_shr_one(0x00010000U, 64, 0x0000000000000000ULL, 0x0000000000000001ULL);
    test_shr_one(0x80010000U, 64, 0x0000000000000000ULL, 0x8000000000000001ULL);
    test_shr_one(0x7FFE0000U, 64, 0x0000000000000000ULL, 0x7FFFFFFFFFFFFFFEULL);
    test_shr_one(0xFFFE0000U, 64, 0x0000000000000000ULL, 0xFFFFFFFFFFFFFFFEULL);
    test_shr_one(0x00010000U, 60, 0x0000000000000000ULL, 0x0000000000000010ULL);
    test_shr_one(0x80010000U, 60, 0x0000000000000008ULL, 0x0000000000000010ULL);
    test_shr_one(0x00018000U, 60, 0x0000000000000000ULL, 0x0000000000000018ULL);
    test_shr_one(0x80018000U, 60, 0x0000000000000008ULL, 0x0000000000000018ULL);
    test_shr_one(0x7FFE0000U, 60, 0x0000000000000007ULL, 0xFFFFFFFFFFFFFFE0ULL);
    test_shr_one(0xFFFE0000U, 60, 0x000000000000000FULL, 0xFFFFFFFFFFFFFFE0ULL);
    test_shr_one(0x7FFE8000U, 60, 0x0000000000000007ULL, 0xFFFFFFFFFFFFFFE8ULL);
    test_shr_one(0xFFFE8000U, 60, 0x000000000000000FULL, 0xFFFFFFFFFFFFFFE8ULL);
    test_shr_one(0x00018000U,  0, 0x0000000000000001ULL, 0x8000000000000000ULL);
    test_shr_one(0x80018000U,  0, 0x8000000000000001ULL, 0x8000000000000000ULL);
    test_shr_one(0x7FFE0000U,  0, 0x7FFFFFFFFFFFFFFEULL, 0x0000000000000000ULL);
    test_shr_one(0xFFFE0000U,  0, 0xFFFFFFFFFFFFFFFEULL, 0x0000000000000000ULL);
    test_shr_one(0x7FFE8000U,  0, 0x7FFFFFFFFFFFFFFEULL, 0x8000000000000000ULL);
    test_shr_one(0xFFFE8000U,  0, 0xFFFFFFFFFFFFFFFEULL, 0x8000000000000000ULL);
}

static void __attribute__((__noinline__)) ATTRIBUTE_NOCLONE
test_shl_one(uint32_t x, int n, uint64_t h, uint64_t l)
{
    Int128 a = expand(x);
    Int128 r = int128_shl(a, n);
    g_assert_cmpuint(int128_getlo(r), ==, l);
    g_assert_cmpuint(int128_gethi(r), ==, h);
}
...
{
    test_shl_one(0x80018001U,  0, 0x8000000000000001ULL, 0x8000000000000001ULL);
    test_shl_one(0x80018001U, 60, 0x1800000000000000ULL, 0x1000000000000000ULL);
    test_shl_one(0x80018001U, 64, 0x8000000000000001ULL, 0x0000000000000000ULL);
    test_shl_one(0x80018001U, 68, 0x0000000000000010ULL, 0x0000000000000000ULL);
}
...
int main(int argc, char **argv)
{
    ...
    g_test_add_func("/int128/int128_shr", test_shr);
    g_test_add_func("/int128/int128_shl", test_shl);
    return g_test_run();
}
