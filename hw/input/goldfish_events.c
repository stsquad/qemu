 ...
 */
static const uint16_t hardbutton_map[Q_KEY_CODE__MAX] = {
...
static const uint16_t hardbutton_shift_map[Q_KEY_CODE__MAX] = {
    [Q_KEY_CODE_F2] = LINUX_KEY_SOFT2,
};

static const uint16_t hardbutton_control_map[Q_KEY_CODE__MAX] = {
                                     ...
                                     InputEvent *evt)
{
    ...
    if (lkey) {
        enqueue_event(s, EV_KEY, lkey, key->down);
    }
}
