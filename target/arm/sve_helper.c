...
DO_ZPZ_FP_D(sve_fcvt_dh, uint64_t, sve_f64_to_f16)
DO_ZPZ_FP_D(sve_fcvt_hd, uint64_t, sve_f16_to_f64)
...
DO_ZPZ_FP_D(sve_fcvtzs_hd, uint64_t, vfp_float16_to_int64_rtz)
DO_ZPZ_FP_D(sve_fcvtzs_sd, uint64_t, vfp_float32_to_int64_rtz)
DO_ZPZ_FP_D(sve_fcvtzs_ds, uint64_t, helper_vfp_tosizd)
DO_ZPZ_FP_D(sve_fcvtzs_dd, uint64_t, vfp_float64_to_int64_rtz)
...
DO_ZPZ_FP_D(sve_fcvtzu_hd, uint64_t, vfp_float16_to_uint64_rtz)
DO_ZPZ_FP_D(sve_fcvtzu_sd, uint64_t, vfp_float32_to_uint64_rtz)
DO_ZPZ_FP_D(sve_fcvtzu_ds, uint64_t, helper_vfp_touizd)
DO_ZPZ_FP_D(sve_fcvtzu_dd, uint64_t, vfp_float64_to_uint64_rtz)
