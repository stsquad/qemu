...
void HELPER(v7m_preserve_fp_state)(CPUARMState *env)
{
    ...
    /*
     * Otherwise s0 to s15 , FPSCRand VPR are UNKNOWN; we choose to leave them
     * unchanged.
     */
}
...
{
    ARMCPU *cpu = env_archcpu(env);uintptr_t ra = GETPC();
...
static void do_v7m_exception_exit(ARMCPU *cpu)
{
...

    {
         ...
         */
        bool spsel = env->v7m.control[return_to_secure] & R_V7M_CONTROL_SPSEL_MASK;uint32_t *frame_sp_p = get_v7m_sp_ptr(env,
                                              return_to_secure,
                                              !return_to_handler,
                                              spsel);
